...
#define WEBSOCKET_MAX_CLIENTS  25000


class WebSocketServer : public ofThread{
	...
	public:
		...
		bool sendRaw(int clientID, string rawString);
		...
		map<int,WebSocketClient>	webSocketClients;
